...
class DemoPingService : public OHOS::SystemAbility, public OHOS::IRemoteStub<IDemoPing> {
public:
    DemoPingService()
        : OHOS::SystemAbility(DEMO_SA_ID, true)
    {
    }
...
int main()
{
    ...
    std::cout << "death_recipient_called: " << (recipient->called ? "true" : "false") << std::endl;
