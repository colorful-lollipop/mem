...
class DemoRegistryAbilityService : public OHOS::SystemAbility,
                                   public OHOS::IRemoteStub<IDemoRegistryAbility> {
 public:
  DemoRegistryAbilityService() : OHOS::SystemAbility(40101, true) {}
