...
- typed 适配层
  以 [`memrpc/include/memrpc/client/typed_invoker.h`](/root/code/demo/mem/memrpc/include/memrpc/client/typed_invoker.h) 和业务层的 typed 注册辅助代码为中心，把业务结构体和底层字节 payload 接起来。
