...
using vpsdemo::testkit::AddReply;
using vpsdemo::testkit::AddRequest;
using vpsdemo::testkit::EchoReply;
using vpsdemo::testkit::EchoRequest;
using vpsdemo::testkit::SleepReply;
using vpsdemo::testkit::SleepRequest;
