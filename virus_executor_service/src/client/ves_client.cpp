...
namespace VirusExecutorService
{
    namespace
    {
        ...
        MemRpc::RecoveryPolicy BuildRecoveryPolicy(const VesClientOptions& options)
        {
            ...
            policy.onFailure = [delay = options.execTimeoutRestartDelayMs](
            ...
            policy.onEngineDeath = [restartDelayMs = options.engineDeathRestartDelayMs](
    ...
    VesClient::VesClient(const OHOS::sptr<OHOS::IRemoteObject>& remote,
        ...
        : VesClient(BuildControlLoader(remote,
                                       VesClientConnectOptions{CONTROL_RELOAD_TIMEOUT_MS}),
                    std::move(options))
    {
    }
                                            ...
                                            uint32_t execTimeoutMs)
    {
        ...
        const uint32_t minRecoveryWaitMs =
