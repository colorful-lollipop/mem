...
{
    return MemRpc::InvokeTypedAsync<EchoRequest, EchoReply>(&client_,
...
{
    return MemRpc::InvokeTypedAsync<AddRequest, AddReply>(&client_,
...
{
    return MemRpc::InvokeTypedAsync<SleepRequest, SleepReply>(&client_,
